...
public WebDriver driver;
	...
	static String generateRandomChars(String candidateChars, int length) {
	...
	public void typevalidEmailID() {
		...
		String emailID = generateRandomChars(ALPHA_NUMERIC_STRING, 7);
	...
	public void createNewCustomer() {
		...
		typeCustomerName("Chinmay");
		setDob("01", "01", "1990");
		typeAddress("2404 Nutwood ave");
		typeCity("Fullerton");
		typeState("California");
		typePinNo("1233456");
		typeTelephone("1234567890");
		typevalidEmailID();
		typePassword("abcde");
		submitNewCust();
